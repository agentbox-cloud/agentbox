...
export class SandboxApi {
  ...
  static async getInfo(
    ...
    const sshRes = await client.api.GET('/sandboxes/{sandboxID}/ssh', {
      params: {
        path: {
          sandboxID: sandboxId,
        },
    ...
    const sshErr = handleApiError(sshRes)
    if (sshErr) {
      throw sshErr
    }
    ...
    return {
      ...
      connectCommand: sshRes.data?.connectCommand ?? '',
      authPassword: sshRes.data?.authPassword ?? '',
    }
  }
  ...
  protected static async createSandbox(
    ...
    const sandboxId = res.data!.sandboxID
    const sshRes = await client.api.GET('/sandboxes/{sandboxID}/ssh', {
      params: {
        path: {
          sandboxID: sandboxId,
