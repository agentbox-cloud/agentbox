...
export class Sandbox extends SandboxApi {
  ...
  constructor(
    ...
    this.connectCommand = opts.connectCommand
    this.authPassword = opts.authPassword
  ...
  static async connect<S extends typeof Sandbox>(
    ...
    return new this(
        { sandboxId, envdAccessToken: info.envdAccessToken, envdVersion: info.envdVersion, ...config,         connectCommand: info.connectCommand, authPassword: info.authPassword, }
    ) as InstanceType<S>
  }
